...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark" suppressHydrationWarning>
      ...
      <body className="font-body antialiased bg-gradient-to-br from-background to-purple-100 dark:from-background dark:to-indigo-950/50 min-h-screen" suppressHydrationWarning>
        <AppProvider>
          {children}
        </AppProvider>
